...
var WatsonService = /** @class */ (function () {
    ...
    WatsonService.prototype.postWatson = function () {
        var _this = this;
        var body = {
    ...
    WatsonService.prototype.getTest = function () {
        this.http.get('https://restcountries.eu/rest/v2/all').subscribe(function (response) {
...
module.exports = __webpack_require__(/*! C:\Users\GiuliaMascagniSilva\Desktop\WatsonAssistant\src\main.ts */"./src/main.ts");
